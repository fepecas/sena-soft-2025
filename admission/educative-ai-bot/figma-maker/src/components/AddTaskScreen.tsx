...
import { ArrowLeft, Calendar as CalendarIcon, Save, Clock, Sparkles } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-green-100 to-orange-100 relative overflow-hidden">
      ...
      <div className="relative z-10 bg-white/80 backdrop-blur-sm border-b border-white/20 sticky top-0">
        <div className="flex items-center justify-between p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-gray-800">Nueva Tarea</h1>
              <p className="text-xs text-gray-600">Organiza tu éxito académico ✨</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10 p-4 pb-8">
        ...
        <div className="relative mb-6 rounded-3xl overflow-hidden shadow-2xl">
          <div className="h-40 relative">
            <ImageWithFallback
              ...
              alt="Estudiante organizando tareas"
              className="w-full h-full object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-r from-blue-600/80 via-green-600/80 to-orange-600/80" />
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center text-white">
                <Sparkles className="h-8 w-8 mx-auto mb-2 animate-pulse" />
                <p className="font-bold text-lg">¡Planifica tu éxito!</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {(selectedSubject || taskTitle) && (
          <Card className="mt-6 p-4 bg-gradient-to-r from-blue-50/80 to-green-50/80 backdrop-blur-sm border border-white/20 rounded-3xl shadow-lg">
      ...
      <div className="fixed bottom-6 left-4 right-4 z-20">
        <Button
          ...
          size="lg"
          className="w-full h-16 bg-gradient-to-r from-blue-600 via-green-600 to-orange-600 hover:from-blue-700 hover:via-green-700 hover:to-orange-700 text-white font-bold shadow-2xl disabled:opacity-50 disabled:cursor-not-allowed rounded-2xl transform transition-all duration-200 hover:scale-105 disabled:transform-none"
        >
