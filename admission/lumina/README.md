...
1. Comenzar con la Descripción del Producto
2. Revisar el Diagrama de Flujo para entender el recorrido del estudiante.
3. Explorar el Prototipo del Producto
4. Ver el Video Explicativo
5. Revisar los Prompts Utilizados para conocer el proceso de construcción.

---------------------------------------------------------------------------------

📖 Resumen

- Problema: Jóvenes en contextos vulnerables carecen de tutores personalizados y de calidad.

- Solución: Un tutor con IA accesible, proactivo y adaptado al estudiante.

- Impacto esperado: Reducir la deserción escolar y mejorar el rendimiento académico mediante educación personalizada.
